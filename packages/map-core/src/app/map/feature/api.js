...
import { parseGoogleSheet } from '@goldeimer/js-util'

import { GOOGLE_SHEETS_API_KEY } from '../../../config'

import { Brand, MerchantType } from '../config/taxonomies'
...
const convertMerchantType = (legacyValue) => {
    ...
    case 'Großmengen':
        return MerchantType.wholesale

    case 'Online-Shops':
        return MerchantType.ecommerce

    case 'Lieferservice':
        return MerchantType.delivery

    default:
        // 'Einzelhandel'
        // 'Einzelhandel (Kiste)'
        return MerchantType.retail
    }
}
